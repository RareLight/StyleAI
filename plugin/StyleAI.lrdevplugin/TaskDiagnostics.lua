...
function TaskDiagnostics.generateReport()
    LrTasks.startAsyncTask(function()
        ...
        table.insert(html, "<li>Gemini API: " .. (detailedHealth.gemini and "<span class='success'>Configured</span>" or "Not Configured") .. "</li>")
        table.insert(html, "<li>ChatGPT API: " .. (detailedHealth.chatgpt and "<span class='success'>Configured</span>" or "Not Configured") .. "</li>")
