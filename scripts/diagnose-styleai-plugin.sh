...
MISSING=0
for file in Info.lua MetadataProvider.lua MetadataTagset.lua Init.lua PluginInfo.lua ShutdownApp.lua TaskAiEditPhotos.lua TaskTrainFromEdits.lua TaskStyleCatalog.lua; do
