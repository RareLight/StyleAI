...
data = {
    "images": [
        {"image": "abc", "photo_id": "1", "filename": "1.jpg", "options": {}}
    ],
    "options": {
        "audit_llm_inputs": "true",
        "audit_llm_inputs_path": "~/TempSSD/logs"
    }
}
...
print("Parsed options:", photo_options.get("audit_llm_inputs"), photo_options.get("audit_llm_inputs_path"))
